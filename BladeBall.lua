...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Fiend1sh/FiendMain/refs/heads/main/OrionUi')))()
local Window = OrionLib:MakeWindow({Name = "Aurora ", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Aurora "})
...
OrionLib:MakeNotification({
	Name = "Aurora ",
	Content = "Aurora  Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
