...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://18875871546" }),
    Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://18875871546" }),
    Settings = Window:AddTab({ Title = "UI Setting", Icon = "rbxassetid://18875871546" })
}
...
Tabs.Main:AddSection("Info")
    ...
    Tabs.Main:AddButton({
        ...
        Description = "Skull Hub Discord Server",
        Callback = function()
            ...
            local StarterGui = game:GetService("StarterGui")
                    StarterGui:SetCore("SendNotification", {
                        Title = "Skull Hub",
                        Text = "Copied Skull Hub discord invite link!",
                        Duration = 3,
                        Icon = "rbxassetid://18875871546"
                    })
        end
    })
